...
export const FormInput: FC<FormInputProps> = ({ loading, errors, onChange, name, touched, values, onBlur, label, autoComplete }): ReactElement => {
  return (
    <div className="p-field p-d-block p-fluid">
      ...
      <span className="p-input-icon-right">
        ...
        <InputText autoComplete={autoComplete} name={name} id={name} onChange={onChange} value={values[name]} onBlur={onBlur} className={`p-d-block ${touched[name] && errors[name] ? 'p-invalid' : ''}`} placeholder="Masukkan nama" />
      </span>
